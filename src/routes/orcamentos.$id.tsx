...
import { ArrowLeft, Briefcase, ChevronDown, Download, FileText, Stethoscope } from "lucide-react";
import { toast } from "sonner";
import { BudgetPricing } from "@/components/portal/budget-pricing";
  ...
  head: () => ({
    meta: [
      { title: "Detalhes da solicitação — Portal de Orçamentos" },
      {
        name: "description",
        content:
          "Dados do paciente, consulta, honorários médicos, valores hospitalares e histórico.",
      },
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    ...
                    <div className="grid gap-2">
                      ...
                      <Input
                        ...
                        placeholder="Ex.: 4"
                        defaultValue={
                          request.fisioterapia !== null ? String(request.fisioterapia) : ""
                        }
                      />
                    </div>
        ...
        <div className="space-y-6">
          ...
          <Card className="shadow-card">
            <details key={id} className="group">
              <summary className="flex cursor-pointer list-none items-center justify-between gap-3 rounded-xl p-6 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring [&::-webkit-details-marker]:hidden">
                <span>
                  <span className="block text-base font-semibold">Histórico do orçamento</span>
